...
document.addEventListener('DOMContentLoaded', () => {
  ...
  externalContainer.addEventListener('click', () => {
    _task__WEBPACK_IMPORTED_MODULE_6__.Task.createTask();
  });
