...
#taskName, #taskNotes, #task-date-picker {
    margin-top: 4px;
    border: none;
    outline: none;
    font-family: inherit;
...
#done-btn.radio-btn-clicked::before {
...
class List {
    ...
    chooseList(event) {
        ...
        _ui__WEBPACK_IMPORTED_MODULE_0__.UI.resetTilesColors();
