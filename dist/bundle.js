...
class ElementsCreator {
    ...
    static createListDiv(list, listContainer) {
        ...
        listItem.addEventListener('dblclick', (event) => {_modal__WEBPACK_IMPORTED_MODULE_3__.Modal.handleDoubleClickOnList(event)}); 
    }
    ...
    static createTaskDatePickerInput(task) {
        ...
        taskDatePickerInput.textContent = task.dueDate ? (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.format)(task.dueDate, 'dd.MM.yyyy') : '';
    ...
    static createTaskDiv(task) {
        ...
        importantBtn.addEventListener('click', (event) => {
            ...
            _todo__WEBPACK_IMPORTED_MODULE_4__["default"].saveToLocalStorage();
        });
    ...
    static fillNewTaskForm(task) {
        ...
        taskNotesInput.value = task.description;
            taskDatePicker.value = task.dueDate ? (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.format)(task.dueDate, 'yyyy-MM-dd') : '';
        if (task.isImportant) {
            importantBtn.classList.add('important-btn-clicked');
        }
        doneBtn.classList.add(task.isDone ? 'radio-btn-clicked' : 'radio-btn-disabled');
...
class Modal {
    ...
    static createModal(heading, id) {
        ...
        const nameLabelElement = _elementsCreator__WEBPACK_IMPORTED_MODULE_2__.ElementsCreator.createInputLabel(`${id}-name`, 'Name:');
        const nameInputElement = _elementsCreator__WEBPACK_IMPORTED_MODULE_2__.ElementsCreator.createInput('text', 'name', `${id}-name`, 60, true, true, '');

        const colorLabelElement = _elementsCreator__WEBPACK_IMPORTED_MODULE_2__.ElementsCreator.createInputLabel(`${id}-color`, 'Color:');
        ...
        if (id === 'add-new-list') {
            formElement.appendChild(_elementsCreator__WEBPACK_IMPORTED_MODULE_2__.ElementsCreator.createModalButtonsDiv(cancelButtonElement, confirmButtonElement));
            dialogElement.appendChild(formElement);
            document.body.appendChild(dialogElement);
        }
        else if (id === 'edit-list') {
            const deleteListBtn = _elementsCreator__WEBPACK_IMPORTED_MODULE_2__.ElementsCreator.createButton('button', 'edit-list-delete-btn', 'Delete');
            formElement.appendChild(_elementsCreator__WEBPACK_IMPORTED_MODULE_2__.ElementsCreator.createModalButtonsDiv(cancelButtonElement, confirmButtonElement, deleteListBtn));
            dialogElement.appendChild(formElement);
            document.body.appendChild(dialogElement);
...
class Task {
  ...
  static createTask() {
    ...
    _todo__WEBPACK_IMPORTED_MODULE_3__["default"].saveToLocalStorage();
  }
